...
public class UiTestInlineEdit extends AbstractUiTest {
    ...
    public void inlineTextEditing() throws Exception {
        ...
        try {
            ...
            ((JavascriptExecutor) we().driver()).executeScript(FileUtilities.inputStreamToString(UiTestInlineEdit.class.getResourceAsStream("UiTestInlineEdit_Edit.js"), "UTF-8"), previewElement);
        } finally {
        ...
        ((JavascriptExecutor) we().driver()).executeScript(FileUtilities.inputStreamToString(UiTestInlineEdit.class.getResourceAsStream("FireEvent.js"), "UTF-8"), "change", textBox);
