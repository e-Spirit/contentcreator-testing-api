...
public class CustomConditions {
	public static ExpectedCondition<Boolean> waitForCC() {
		return driver -> {
			boolean weApiAvailable = ((JavascriptExecutor) driver).executeScript("return typeof top.WE_API !== 'undefined'").equals(Boolean.TRUE);
			...
			{
				WebElement previewFrame = driver.findElement(By.id("previewContent"));
				driver.switchTo().frame(previewFrame);
				boolean previewState = ((JavascriptExecutor) driver).executeScript("return document.readyState").equals("complete");
