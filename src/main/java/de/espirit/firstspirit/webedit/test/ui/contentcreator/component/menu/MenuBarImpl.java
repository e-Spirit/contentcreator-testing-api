...
public class MenuBarImpl implements MenuBar {
  ...
  public Menu actionMenu() {
    return new MenuImpl(this.webDriver, By.cssSelector(
        "#fs-toolbar > div.fs-toolbar-content.fs-toolbar-content-main > div:nth-child(5) > div > div:nth-child(4)"));
  }
  ...
  public Menu contentMenu() {
    return new MenuImpl(this.webDriver, By.cssSelector(
        "#fs-toolbar > div.fs-toolbar-content.fs-toolbar-content-main > div:nth-child(5) > div > div:nth-child(1)"));
  }


  @Override
  public void search(final String query) throws CCAPIException {
    final WebElement element = Utils.find(this.webDriver,
        ExpectedConditions.presenceOfElementLocated(By.className("fs-searchtextbox-field")));
    element.click();
  ...
  public WebElement html() throws CCAPIException {
    return Utils.find(this.webDriver,
        ExpectedConditions.presenceOfElementLocated(By.className("fs-toolbar-state")));
  }
   ...
   * (non-Javadoc)
   *
   * @see de.espirit.firstspirit.webedit.test.ui.contentcreator.component.menu.MenuBar#
