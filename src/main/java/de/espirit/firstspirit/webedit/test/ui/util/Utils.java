...
public class Utils {
    ...
    /**
     * Finds a web element by the given fs element name
     *
     * @param webDriver The webdriver instance
     * @param selector The selector defines the path to the element
     * @param fsElementName The fs element name of the web element
     * @return Returns the web element if found
     */
    public static WebElement findElementByFsElementName(@NotNull final WebDriver webDriver, @NotNull final By selector, @NotNull final String fsElementName) {
        List<WebElement> elements = Utils.findElements(webDriver, selector);
        for (WebElement element : elements) {
            String elementName = element.getAttribute("data-fs-element-name");
            if (elementName.equals(fsElementName)) {
                return element;
            }
        }
