...
public class CCDialogsImpl implements CCDialogs {
  ...
  public CCWizardDialog wizardDialog() throws CCAPIException {
    final WebElement dialog = Utils.find(this.webDriver,
        ExpectedConditions.visibilityOfElementLocated(By.className("fs-WizardDialogBox")));
  ...
  public CCDialog dialog() throws CCAPIException {
    final WebElement dialog = Utils.find(this.webDriver,
        ExpectedConditions.visibilityOfElementLocated(By.className("fs-DialogBox")));

    if (!ComponentUtils.hasElement(dialog, this.webDriver,
        By.className("fs-MessageDialogBox-Container"))) {
