...
public class UiTestDragDrop extends AbstractUiTest {
    ...
    public void moveSection() throws Exception {
        ...
        try {
            ...
            ((RemoteWebDriver) we().driver()).executeScript(FileUtilities.inputStreamToString(UiTestDragDrop.class.getResourceAsStream("UiTestDragDrop.js"), "UTF-8"), action.html(), section2element);
            Thread.sleep(1000);
        } finally {
